...
public class BusinessOwnerRegisterActivity extends AppCompatActivity {
        ...
        FirebaseAuth.getInstance().createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(BusinessOwnerRegisterActivity.this, "Error" + error, Toast.LENGTH_SHORT).show();
    ...
    private void saveDataToFile() {
        ...
        Intent intent = new Intent(BusinessOwnerRegisterActivity.this, BusinessOwnerSetupActivity.class);
