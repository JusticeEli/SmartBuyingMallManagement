...
public class BusinessOwnerLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_owner_login);
        initWidgets();
        setOnClickListeners();
    }
        ...
        FirebaseAuth.getInstance().signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    Toast.makeText(BusinessOwnerLoginActivity.this, "Login Success!!", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BusinessOwnerLoginActivity.this, BusinessOwnerFirstPageActivity.class);
                    ...
                    Toast.makeText(BusinessOwnerLoginActivity.this, "Error: "+error, Toast.LENGTH_SHORT).show();
                }
                showProgress(false);
            }
        });
